...
class SupabaseDatabase:
    ...
    def save_results(self, results_data: PickemResults) -> bool:
        """
        Save results to Supabase database using upsert to handle updates.
        Automatically calculates rankings and metadata.

        Args:
            results_data: PickemResults object containing week results
    ...
    def get_results(self, week_number: int, season: int = None) -> Optional[PickemResults]:
        ...
        Returns:
            PickemResults object or None if not found
        """
