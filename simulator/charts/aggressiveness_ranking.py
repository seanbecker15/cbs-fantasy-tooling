...
def create_aggressiveness_chart(
    metrics_df: pd.DataFrame, week: int, output_dir: str = "../out"
) -> str:
    """
...
def main():
    ...
    parser.add_argument(
        "--week", type=int, default=None, help="NFL week number (default: current week)"
    )
    parser.add_argument(
        "--data-dir",
        type=str,
